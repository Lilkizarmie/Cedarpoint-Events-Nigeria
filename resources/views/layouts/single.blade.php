...
<head>
  ...
  <title>CedarPoint - Decoration | Event Hall | Planning</title>
  ...
  <div class="animsition">
        ...
        <div class="container-fluid clearfix">
          ...
          <div class="menu">
            ...
            <div class="menu-main" id="accordion">
              <ul>
                <li><a href="{{url('/')}}" class="active" class="animsition-link" data-animsition-out-class="fade-out"
                    data-text="Home">Home</a></li>
                <li><a href="{{url('/about')}}" class="animsition-link" data-animsition-out-class="fade-out"
                    data-text="About Us">About Us</a></li>
                <li><a href="{{url('/services')}}" class="animsition-link" data-animsition-out-class="fade-out"
                    data-text="Services">Services</a></li>
                <li><a href="{{url('/gallery')}}" class="animsition-link" data-animsition-out-class="fade-out"
                    data-text="Gallery">Gallery</a></li>
                {{-- <li><a href="#" class="animsition-link" data-animsition-out-class="fade-out" data-text="Shop">Shop</a>
                </li> --}}
                <li><a href="{{url('/blog')}}" class="animsition-link" data-animsition-out-class="fade-out" data-text="Blog">Blog</a>
                </li>
                <li><a href="{{url('/contact')}}" class="animsition-link" data-animsition-out-class="fade-out"
            ...
            <div class="menu-footer">
              ...
              <div class="menu-copyright">&copy; 2022 <strong>CEDARPOINT</strong>. All Rights Reserved.<br /> design by
                <strong>infixdev</strong></div>
            </div>
          </div>
      </header>
    ...
    <div class="footer">
      <div class="footer-flash-about home-flash-dark">
        <div class="container">
          Tell us more about what you want to accomplish with your event. We help you think of possible solutions and
      ...
      <div class="footer-flash home-flash-dark">
        <div class="container">
            ...
            <div class="row">
              <div class="col-md-4 col-6 mb-5">
                ...
                <div class="contact-item"><a
                    href="enquiries@cedarpointevent.com"><span
                      class="__cf_email__"
                      data-cfemail="9bf3fef7f7f4dbf7feecf2e8e8efeefff2f4b5f8f4">enquiries@cedarpointevent.com</span></a>
                </div>
                <div class="contact-item"><a href="tel:+2348031555002" class="phone-link">+234 803 155 5002</a></div>
              </div>
          ...
          <div class="site-info">
            <div class="row">
              <div class="col-6">
                <div class="copyright text-left">&copy; 2022 <strong>CEDARPOINT EVENTS</strong>. All Rights Reserved.
                </div>
              </div>
              <div class="col-6">
                <div class="text-right">Design by <strong><a href="http://infixdev.co">infixdev</a></strong></div>
              </div>
            </div>
          </div>
        </div>
