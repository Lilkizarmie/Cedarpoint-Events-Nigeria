...
<head>
    ...
    <title>Works - Decoration | Event Hall | Planning</title>
                    ...
                    <div class="menu">
                        ...
                        <div class="menu-main" id="accordion">
                            <ul>
                                ...
                                <li><a href="contact.html" class="animsition-link"
                                        data-animsition-out-class="fade-out" data-text="Contact">Contact</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="section-item">
                        <div class="photo-list">
                            <div class="photo-item wow fadeInLeft" data-wow-delay=".3s" data-wow-offset="100">
                                <div class="container"><img src="img/pic94.jpg" alt="" /></div>
                            </div>
                            <div class="photo-item wow fadeInRight" data-wow-delay=".3s" data-wow-offset="100">
                                <div class="container"><img src="img/pic95.jpg" alt="" /></div>
                            </div>
                            <div class="photo-item wow fadeInUp" data-wow-delay=".3s" data-wow-offset="100">
                                <img src="img/pic96.jpg" alt="" />
                            </div>
                            <div class="row align-items-center">
                                <div class="col-md-6 photo-item wow fadeInLeft" data-wow-delay=".3s"
                                    data-wow-offset="100"><img src="img/pic97.jpg" alt="" /></div>
                                <div class="col-md-6 photo-item wow fadeInRight" data-wow-delay=".3s"
                                    data-wow-offset="100"><img src="img/pic98.jpg" alt="" /></div>
                            </div>
                        </div>
                    </div>
                    <div class="section-item">
